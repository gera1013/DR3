...
class RayTracer(object):
    ...
    def glCastRay(self, origin, direction, origin_object = None, recursion = 0):
        ...
        ambient_color = diffuse_color = spec_color = reflect_color = refract_color = final_color = [0, 0, 0]
        ...
        if self.point_light:
            ...
            if shadow_intercept is not None and shadow_intercept.distance < mathFrobenius(mathVectorSubstraction(self.point_light.position, intersect.point)):
                shadow_intensity = 1
        ...
        if material.type == OPAQUE:
            ...
            final_color = mathVectorAdd(reflect_color, mathVectorTimesScalar((1 - shadow_intensity), spec_color))
            ...
            final_color = mathVectorAdd(mathVectorAdd(mathVectorTimesScalar(kr, reflect_color), mathVectorTimesScalar((1 - kr), refract_color)), mathVectorTimesScalar((1 - shadow_intensity), spec_color))
